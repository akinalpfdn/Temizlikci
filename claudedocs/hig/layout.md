...
Apple provides templates and layout guides that can help you integrate Apple technologies and design your apps and games to run on all Apple platforms. See [].
...
- Regular and compact horizontal and vertical [layout#Size-classes]
...
For developer guidance, see [UITraitChangeObservable-67e94] and [UserInterfaceSizeClass].
