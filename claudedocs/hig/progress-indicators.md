...
Let people know when halting a process has a negative consequence. When canceling a process results in lost progress, it’s helpful to provide an [alerts] that includes an option to confirm the cancellation or resume the process.
